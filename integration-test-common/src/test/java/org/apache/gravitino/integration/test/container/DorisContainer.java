 ...
 *
 * <p>This class implements {@link ContainerLifecycle} directly (rather than extending {@link
 * BaseContainer}) because it delegates entirely to a {@link ComposeContainer} and does not use a
 * single {@link org.testcontainers.containers.GenericContainer}.
 */
public class DorisContainer implements ContainerLifecycle {
  ...
  protected DorisContainer(String image) {
  ...
  /** Builder for {@link DorisContainer}. */
  public static class Builder {
    ...
    /**
     * Accepted for API compatibility with {@link ContainerSuite} but the hostname is managed by
     * docker-compose internally.
     */
    public Builder withHostName(String hostName) {
      // docker-compose manages hostnames via service names; parameter accepted for compatibility
      return this;
    }

    /**
     * Accepted for API compatibility with {@link ContainerSuite} but the network is managed by
     * docker-compose internally.
     */
    public Builder withNetwork(org.testcontainers.containers.Network network) {
      // docker-compose manages its own network; parameter accepted for compatibility
      return this;
    }

    public DorisContainer build() {
      return new DorisContainer(image);
    }
  }
}
