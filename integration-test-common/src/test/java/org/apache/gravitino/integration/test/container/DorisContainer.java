...
public class DorisContainer extends BaseContainer {
  ...
  private DorisITContainers dorisITContainers;
  ...
  protected DorisContainer(
    ...
    this.dorisITContainers = new DorisITContainers();
  }
  ...
  public void start() {
    ...
    try {
      ...
      throw new RuntimeException("Failed to start Doris cluster", e);
    }
  }
  ...
  public void close() {
    try {
      dorisITContainers.close();
    } catch (Exception e) {
      LOG.error("Failed to close Doris cluster", e);
    }
    super.close();
  }
